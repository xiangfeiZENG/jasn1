...
public class LocationInformation implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.APPLICATION_CLASS, BerTag.CONSTRUCTED, 138);
	...
	public LocationInformation(byte[] code) {
		this.code = code;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (networkLocation != null) {
			codeLength += networkLocation.encode(reverseOS, true);
		}
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(NetworkLocation.tag)) {
			networkLocation = new NetworkLocation();
			subCodeLength += networkLocation.decode(is, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (networkLocation != null) {
			...
			networkLocation.appendAsString(sb, indentLevel + 1);
