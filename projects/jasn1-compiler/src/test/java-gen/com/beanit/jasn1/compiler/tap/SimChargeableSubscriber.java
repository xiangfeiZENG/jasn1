...
public class SimChargeableSubscriber implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.APPLICATION_CLASS, BerTag.CONSTRUCTED, 199);
	...
	public SimChargeableSubscriber(byte[] code) {
		this.code = code;
	}
