...
public class GprsDestination implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.APPLICATION_CLASS, BerTag.CONSTRUCTED, 116);
	...
	public GprsDestination(byte[] code) {
		this.code = code;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (accessPointNameOI != null) {
			codeLength += accessPointNameOI.encode(reverseOS, true);
		}
		
		if (accessPointNameNI != null) {
			codeLength += accessPointNameNI.encode(reverseOS, true);
		}
