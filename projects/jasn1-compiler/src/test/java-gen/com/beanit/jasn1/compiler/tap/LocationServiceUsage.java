...
public class LocationServiceUsage implements BerType, Serializable {
	...
	public void setLCSQosRequested(LCSQosRequested lCSQosRequested) {
		this.lCSQosRequested = lCSQosRequested;
	}

	public LCSQosRequested getLCSQosRequested() {
		return lCSQosRequested;
	}

	public void setLCSQosDelivered(LCSQosDelivered lCSQosDelivered) {
		this.lCSQosDelivered = lCSQosDelivered;
	}

	public LCSQosDelivered getLCSQosDelivered() {
		return lCSQosDelivered;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (lCSQosDelivered != null) {
			codeLength += lCSQosDelivered.encode(reverseOS, true);
		}
		
		if (lCSQosRequested != null) {
			codeLength += lCSQosRequested.encode(reverseOS, true);
		}
