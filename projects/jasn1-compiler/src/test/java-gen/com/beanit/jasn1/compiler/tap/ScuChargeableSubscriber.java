...
public class ScuChargeableSubscriber implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public byte[] code = null;
	public static final BerTag tag = new BerTag(BerTag.APPLICATION_CLASS, BerTag.CONSTRUCTED, 430);
	...
	public ScuChargeableSubscriber(byte[] code) {
		this.code = code;
	}

	public void setGsmChargeableSubscriber(GsmChargeableSubscriber gsmChargeableSubscriber) {
		this.gsmChargeableSubscriber = gsmChargeableSubscriber;
	}

	public GsmChargeableSubscriber getGsmChargeableSubscriber() {
		return gsmChargeableSubscriber;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (gsmChargeableSubscriber != null) {
			codeLength += gsmChargeableSubscriber.encode(reverseOS, true);
			codeLength += BerLength.encodeLength(reverseOS, codeLength);
			if (withTag) {
				codeLength += tag.encode(reverseOS);
			}
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(GsmChargeableSubscriber.tag)) {
			gsmChargeableSubscriber = new GsmChargeableSubscriber();
			codeLength += gsmChargeableSubscriber.decode(is, false);
			return codeLength;
		}
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (gsmChargeableSubscriber != null) {
			sb.append("gsmChargeableSubscriber: ");
			gsmChargeableSubscriber.appendAsString(sb, indentLevel + 1);
			return;
		}
